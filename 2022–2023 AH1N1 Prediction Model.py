...
# Specify a locally installed font file (e.g., Microsoft YaHei); the path must exist.
...
def train_final_and_predict(train_df, full_df, predict_start, predict_end, plot=True):
    ...
    model.save('multimodal_model_2022_2023.h5')
    np.savez('multimodal_inputs_2022_2023.npz',
             X_epi_p=X_epi_p,
...
if __name__ == "__main__":
    ...
    if full_df.empty:
        ...
        sys.exit()
    print("Forecasting the 2022-2023 epidemic season (excluding anomalous epidemic seasons)...")
