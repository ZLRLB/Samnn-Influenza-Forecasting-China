...
# Use a locally installed CJK font; the path must exist
...
# lead=4: lag4-lag7
# ============================================================
FORECAST_LEAD = 2   # Set to 1, 2, or 4 for the corresponding forecast horizon
...
PREDICT_START = "2022-11-02"
PREDICT_END = "2023-04-05"
EPOCHS = 100
BATCH_SIZE = 16
SEED = 42
...
def train_final_and_predict(train_df, full_df, predict_start, predict_end, plot=True):
    ...
    model.save(f'revised_multimodal_model_2022_2023_lead{FORECAST_LEAD}wk.h5')
    np.savez(
        f'revised_multimodal_inputs_2022_2023_lead{FORECAST_LEAD}wk.npz',
        X_epi_p=X_epi_p,
...
if __name__ == "__main__":
    ...
    if full_df.empty:
        ...
        sys.exit()
    print("Forecasting the 2022/23 season after excluding low-activity seasons...")
